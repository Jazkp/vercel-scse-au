  ...
  return (
    <main className={styles.question}>
      ...
      <code>
        ...
        <br />
        What type of environment are you running the build on? (OS, Programming
        Language, Network) - Have you tried using different environment
        settings?
        <br />
        Are you getting any specific error message/s? Please provide screenshots
        if so.
        <br />
