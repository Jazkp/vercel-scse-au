  ...
  return (
    <main className={styles.question}>
      ...
      <p style={{ fontSize: "20px" }}>
        ...
        My certifications at TAFE allowed me to explore the frontend in a
        different way, proving it could be also extremely powerful if used to
        its maximum potential. Vercel will allow me to dig and learn more about
        frontend, and especially Next.js
      </p>
    </main>
  );
}
