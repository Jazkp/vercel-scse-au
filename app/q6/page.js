  ...
  return (
    <main className={styles.question}>
      ...
      <code>
        ...
        <br />
        I understand how frustrating and time consuming this situation is. Rest
        assured that I will do my best to get this working ASAP.
        <br />
        <br />
        ...
        another webiste, please find the solutions below: <br />
        <br />
        ...
        <br />
        <br />
        In regards to the issue with not indexing by Search Engines the project,
        please find the solutions below: <br />
        <br />
